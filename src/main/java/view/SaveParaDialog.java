...
public class SaveParaDialog extends JDialog {
    ...
    public SaveParaDialog(Main main) {
        this.main = main;
    ...
    private void onOK() {
        ...
        if (Choice.getInstance().getMethod().equals("求四参数")) {
            ...
            resultParameters4.name = name;
            Config.saveParameters4(resultParameters4);
            ...
            resultParameters7.name = name;
            Config.saveParameters7(resultParameters7);
        }
        main.updateTable();
        dispose();
    }
